            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        {user.profilePicture ? (
                            <img src={user.profilePicture.replace('https://res.cloudinary.com/daxvjw2au/image/upload/', '/images/')} alt={user.name} className="w-24 h-24 rounded-full object-cover" />
                        ) : (
